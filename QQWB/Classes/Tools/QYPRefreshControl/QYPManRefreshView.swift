//
//  QYPManRefreshView.swift
//  QQWB
//
//  Created by 高级iOS开发 on 2017/10/18.
...
class QYPManRefreshView: QYPRefreshView {
    ...
    /// 父视图高度
    override var paraentViewHeight: CGFloat {
        didSet {
            print("父视图高度 \(paraentViewHeight)")
            
            if paraentViewHeight < 23 {
                return
            }
            ...
            if paraentViewHeight > 126 {
                scale = 1
            } else {
                scale = 1 - ((126 - paraentViewHeight) / (126 - 23))
            }
